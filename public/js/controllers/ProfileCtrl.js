angular.module('ProfileCtrl', []).controller('ProfileController', function($scope, $sce) {
	...
	$scope.workInfo = [{
		...
		description: $sce.trustAsHtml('<p>Designed & Developed scalable web application to build digital platform for healthcare industry. Roles also included configuring cloud infrastructure to make application reliable & scalable, to facilitate Demilitarized zone, and proactively enforce security measures.</p><p>Technologies used: Mongo DB, Node.JS, AngularJS, ElasticSearch, Nginx, ELK stack.')
	}, {
		year: 'June 2013 - April 2015 ',
		company: ' IBM India Pvt. Ltd.',
		role: ' Application Developer',
		description: $sce.trustAsHtml('<p>Developed and maintained business reports for a shipping giant. The reports helped customer gain better insights for demurrage & detention charges, vessel tracking, job booking and vessel filling optimisation. Developed a tool which automates account reset and creation process for client users with PYTHON and UNIX.</p><p>Technologies used: Python, Unix shell scripting, SQL, COGNOS, Qlikview.')
	}, {
		year: 'July 2011 - May 2012 ',
		company: ' ACM chapters, SVNIT ',
		role: ' Executive Committee Member',
		description: $sce.trustAsHtml('<p>Organized and Conducted various seminars, competitions, hackathons and training sessions. Collaborated with fellow ACM mates to participate in competitive programming and develop various applications.</p>')
	}];

	$scope.education = [{
		title: 'Machine Learning Certification, 2016',
		univ: ' Stanford Online course - Coursera',
		description: $sce.trustAsHtml('<p>Completed training in machine learning course by Andrew NG from Stanford University and earned a certificate. The course provided a broad introduction to machine learning, datamining, and statistical pattern recognition.</p>')
	}, {
		title: 'B.Tech in Computer Engineering, 2013',
		univ: ' SVNIT, Surat ',
		description: $sce.trustAsHtml('<p>Courses: Data Structures, Algorithm analysis and design, Theoretical Computer Science, Operating Systems, Systems software, Microprocessors & Interfacing Techniques, Information systems, Network & system security, Security in Embedded systems, Distributed systems, Engineering Mathmematics, and Artificial Intelligence.</p><p> Project on Evaluation of Privacy Homomorphic algoritms in Wireless Sensor Networks. Published a paper in IJCA for same. Seminar on Secure boot</p>')
	}, {
		title: 'Java professional course, 2009',
		univ: ' Aptech Edu. Ltd. ',
		description: $sce.trustAsHtml('<p>Completed the course of JAVA Core developer from Aptech in 2009. The course provided an understanding of core OOPS principle, advanced data structures and principles of software design.</p>')
	}];
